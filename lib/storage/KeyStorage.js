...
// two possible modes for backwards compatibility
...
export class KeyStorage {
  constructor({collectionName, recordCipher, cache} = {}) {
    ...
    // FIXME: figure out cache integration
    this.cache = cache;
  ...
  async get({id, useCache = true} = {}) {
    ...
    const record = (this.cache && useCache) ?
