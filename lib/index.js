 ...
 */
exports.getKeyCount = async ({keystoreId} = {}) => {
 ...
 */
exports.generateKey = async ({keyId, controller, operation}) => {
 ...
 * @returns {Promise<object>} Key information.
 */
exports.getKeyDescription = async ({keyId, controller} = {}) => {
 ...
 */
exports.wrapKey = async ({keyId, operation, zcapInvocation}) => {
  assert.string(keyId, 'options.keyId');
  assert.object(operation, 'options.operation');
 ...
 */
exports.unwrapKey = async ({keyId, operation, zcapInvocation}) => {
  assert.string(keyId, 'options.keyId');
  assert.object(operation, 'options.operation');
 ...
 */
exports.sign = async ({keyId, operation, zcapInvocation}) => {
  assert.string(keyId, 'options.keyId');
  assert.object(operation, 'options.operation');
 ...
 */
exports.verify = async ({keyId, operation, zcapInvocation}) => {
  assert.string(keyId, 'options.keyId');
  assert.object(operation, 'options.operation');
 ...
 */
exports.deriveSecret = async ({keyId, operation, zcapInvocation}) => {
  assert.string(keyId, 'options.keyId');
  assert.object(operation, 'options.operation');
